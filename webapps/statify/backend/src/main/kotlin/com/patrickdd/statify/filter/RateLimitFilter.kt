package com.patrickdd.statify.filter
...
class RateLimitFilter : OncePerRequestFilter() {
    ...
    companion object {
        private const val CAPACITY = 10L // Maximum amount of tokens a bucket can hold
        private const val REFILL_AMOUNT_TOKENS = 5L // Amount of tokens added back
        private const val REFILL_INTERVAL_SECONDS = 10L // Interval to add tokens
    }
